...
@interface TestService() <MSFilter>
...
- (void)refreshDataOnSuccess:(QSCompletionBlock)completion
{
    ...
    [self.table readWithPredicate:predicate completion:^(NSArray *bla, NSInteger totalCount, NSError *error)
...
//use this jsonDictionary as body if passord required
//NSDictionary *jsonDictionary = [NSDictionary dictionaryWithObjectsAndKeys: @"user123", @"username", @"pass123", @"password", nil];
...
- (void) getAll:(MSAPIDataBlock)completion
{
    NSDictionary *jsonDictionary = [NSDictionary dictionaryWithObjectsAndKeys: @"0", @"level", nil];
    
    [self.client
     invokeAPI:@"getalltest"
     data:nil
     HTTPMethod:@"GET"
